...
#    lang = tarski.language(theories=[Theory.ARITHMETIC])
#    x = lang.variable("x", lang.Boolean)
#    y = lang.variable("y", lang.Boolean)
...
#
#    a = lang.constant(True, lang.Boolean)
#    b = lang.constant(True, lang.Boolean)
#    g = (x() == y() + (a() & b()))
#
...
#    lang = tarski.language(theories=[Theory.ARITHMETIC, Theory.BOOLEAN])
#
#    c1 = lang.constant(True, lang.Boolean)
#    v = lang.variable('v', lang.Boolean)
#    x = lang.variable('x', lang.Integer)
...
#    b = (x > y) | (c1 & v)
#
#    qf = tarski.syntax.formulas.forall(v,x,y, b = 5)
#    assert isinstance(g, QuantifiedFormula), "should have built a quantified formula"
#    #todo: better test
