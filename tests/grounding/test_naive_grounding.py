...
from tarski.grounding import NaiveGroundingStrategy, ProblemGrounding, create_all_possible_state_variables
...
from ..fstrips.hybrid.tasks import create_billiards_world, create_particles_world
...
def test_problem_grounding_on_parcprinter():
    ...
    assert as_list2(variables) == [
        ...
        "Location(sheet1,Finisher2_Tray)",
        ...
        "Stackedin(sheet1,Some_Finisher_Tray)",
        "total-cost()",
    ]
