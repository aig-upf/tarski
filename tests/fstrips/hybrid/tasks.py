...
from tests.common.numeric import generate_billiards_instance, generate_numeric_instance
...
def create_billiards_world():
    ...
    _ = task.reaction(
        "principle_of_superposition", [b, d], top, fs.FunctionalEffect(a(d, b), summation(ftype, F(ftype, d, b)) / m(b))
    )
