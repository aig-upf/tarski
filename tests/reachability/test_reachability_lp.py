...
from tarski.reachability.asp import LogicProgram, LPAtom, ReachabilityLPCompiler, create_reachability_lp
...
def test_lp_translation():
    ...
    fake = problem.action("gripper", [g], precondition=gripper(g), effects=[fs.AddEffect(gripper(g))])
