...
def main():
    ...
    prefix = args.grammar
    pattern = os.path.join(tmpdir.name,"grammars/{}*.py".format(prefix))
...
def run_antlr(args):
    ...
    if os.name == 'nt':
        ...
        antlr_jar = os.environ.get("ANTLR_PATH", ".")
        command = ('java -Xmx500M -cp "{}:$CLASSPATH" org.antlr.v4.Tool -visitor -Dlanguage=Python3 -o {} {}'.
                   format(antlr_jar, tmpdir.name, args.grammar_filename))
    try:
        os.system(command)
    except Exception:
