...
def main():
    ...
    prefix = args.grammar
    pattern = "/tmp/grammars/{}*.py".format(prefix)
...
def run_antlr(args):
    ...
    command = ('java -Xmx500M -cp "{}:$CLASSPATH" org.antlr.v4.Tool -visitor -Dlanguage=Python3 -o /tmp {}'.
               format(antlr_jar, args.grammar_filename))
    try:
        os.system(command)
    except Exception:
