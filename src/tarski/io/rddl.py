...
logic_rddl_to_tarski = {"=>": implies, "^": land, "|": lor, "~": neg}

relational_rddl_to_tarski = {"==": BPS.EQ, "<=": BPS.LE, ">=": BPS.GE}
...
class Reader:
    ...
    def translate_rddl_model(self):
        ...
        self.language = language(
            self.rddl_model.domain.name, theories=[Theory.EQUALITY, Theory.ARITHMETIC, Theory.SPECIAL, Theory.RANDOM]
        )
